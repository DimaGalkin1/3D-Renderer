 ...
 * \sa SDL_GetNumVideoDisplays
 */
extern DECLSPEC int SDLCALL SDL_GetDisplayDPI(int displayIndex, double * ddpi, double * hdpi, double * vdpi);
 ...
 */
extern DECLSPEC int SDLCALL SDL_SetWindowBrightness(SDL_Window * window, double brightness);
 ...
 */
extern DECLSPEC double SDLCALL SDL_GetWindowBrightness(SDL_Window * window);
 ...
 */
extern DECLSPEC int SDLCALL SDL_SetWindowOpacity(SDL_Window * window, double opacity);
 ...
 * \param out_opacity the double filled in (0.0f - transparent, 1.0f - opaque)
 * \returns 0 on success or a negative error code on failure; call
 *          SDL_GetError() for more information.
 *
 * \since This function is available since SDL 2.0.5.
 ...
 */
extern DECLSPEC int SDLCALL SDL_GetWindowOpacity(SDL_Window * window, double * out_opacity);
