 ...
 *
 *  By default the Home button LED state is not changed. This hint can also be set to a doubleing point value between 0.0 and 1.0 which controls the brightness of the Home button LED.
 */
 ...
 *    "1"       - home button LED is turned on
 *
 *  By default the Home button LED state is not changed. This hint can also be set to a doubleing point value between 0.0 and 1.0 which controls the brightness of the Home button LED. The default brightness is 0.4.
 */
...
/**
 *  \brief  A variable setting the speed scale for mouse motion, in doubleing point, when the mouse is not in relative mode
 */
...
/**
 *  \brief  A variable setting the scale for mouse motion, in doubleing point, when the mouse is in relative mode
 */
