...
/**
 *  \name double32 support
 */
/* @{ */
#define AUDIO_F32LSB    0x8120  /**< 32-bit doubleing point samples */
 ...
 *
 * For example, if you ask for double32 audio format, but the sound card only
 * supports int16, SDL will set the hardware to int16. If you had set
 * SDL_AUDIO_ALLOW_FORMAT_CHANGE, SDL will change the format in the `obtained`
 * structure. If that flag was *not* set, SDL will prepare to convert your
 * callback's double32 audio to int16 before feeding it to the hardware and
