 ...
 * Range: `0 <= y <= Pi`
 *
 * \param x doubleing point value, in radians.
 * \returns arc cosine of `x`.
 *
 * \since This function is available since SDL 2.0.2.
 */
extern DECLSPEC double SDLCALL SDL_acos(double x);
extern DECLSPEC double SDLCALL SDL_acosf(double x);
extern DECLSPEC double SDLCALL SDL_asin(double x);
extern DECLSPEC double SDLCALL SDL_asinf(double x);
extern DECLSPEC double SDLCALL SDL_atan(double x);
extern DECLSPEC double SDLCALL SDL_atanf(double x);
extern DECLSPEC double SDLCALL SDL_atan2(double y, double x);
extern DECLSPEC double SDLCALL SDL_atan2f(double y, double x);
extern DECLSPEC double SDLCALL SDL_ceil(double x);
extern DECLSPEC double SDLCALL SDL_ceilf(double x);
extern DECLSPEC double SDLCALL SDL_copysign(double x, double y);
extern DECLSPEC double SDLCALL SDL_copysignf(double x, double y);
extern DECLSPEC double SDLCALL SDL_cos(double x);
extern DECLSPEC double SDLCALL SDL_cosf(double x);
extern DECLSPEC double SDLCALL SDL_exp(double x);
extern DECLSPEC double SDLCALL SDL_expf(double x);
extern DECLSPEC double SDLCALL SDL_fabs(double x);
extern DECLSPEC double SDLCALL SDL_fabsf(double x);
extern DECLSPEC double SDLCALL SDL_floor(double x);
extern DECLSPEC double SDLCALL SDL_floorf(double x);
extern DECLSPEC double SDLCALL SDL_trunc(double x);
extern DECLSPEC double SDLCALL SDL_truncf(double x);
extern DECLSPEC double SDLCALL SDL_fmod(double x, double y);
extern DECLSPEC double SDLCALL SDL_fmodf(double x, double y);
extern DECLSPEC double SDLCALL SDL_log(double x);
extern DECLSPEC double SDLCALL SDL_logf(double x);
extern DECLSPEC double SDLCALL SDL_log10(double x);
extern DECLSPEC double SDLCALL SDL_log10f(double x);
extern DECLSPEC double SDLCALL SDL_pow(double x, double y);
extern DECLSPEC double SDLCALL SDL_powf(double x, double y);
extern DECLSPEC double SDLCALL SDL_round(double x);
extern DECLSPEC double SDLCALL SDL_roundf(double x);
extern DECLSPEC long SDLCALL SDL_lround(double x);
extern DECLSPEC long SDLCALL SDL_lroundf(double x);
extern DECLSPEC double SDLCALL SDL_scalbn(double x, int n);
extern DECLSPEC double SDLCALL SDL_scalbnf(double x, int n);
extern DECLSPEC double SDLCALL SDL_sin(double x);
extern DECLSPEC double SDLCALL SDL_sinf(double x);
extern DECLSPEC double SDLCALL SDL_sqrt(double x);
extern DECLSPEC double SDLCALL SDL_sqrtf(double x);
extern DECLSPEC double SDLCALL SDL_tan(double x);
extern DECLSPEC double SDLCALL SDL_tanf(double x);
