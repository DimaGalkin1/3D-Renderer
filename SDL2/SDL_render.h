...
extern DECLSPEC int SDLCALL SDL_RenderGeometryRaw(SDL_Renderer *renderer,
                                               SDL_Texture *texture,
                                               const double *xy, int xy_stride,
                                               const SDL_Color *color, int color_stride,
                                               const double *uv, int uv_stride,
                                               int num_vertices,
 ...
 * \param texw a pointer to a double value which will be filled with the
 *             texture width or NULL if you don't need that value
 * \param texh a pointer to a double value which will be filled with the
 ...
 */
extern DECLSPEC int SDLCALL SDL_GL_BindTexture(SDL_Texture *texture, double *texw, double *texh);
